import re
import sys
from FeatureSandBox.TapeReader import GetSentences
from FeatureSandBox.AC_pythonexample import TrieNode, Trie, ProcessTextWTrie
...
class PairMatchPage(QWidget):
    ...
    def receiveData(self, msg):
        print('Message from Loader page recieved :', msg)
        self.word_counts = msg['word counts']
        self.myTrie = msg['myTrie']
